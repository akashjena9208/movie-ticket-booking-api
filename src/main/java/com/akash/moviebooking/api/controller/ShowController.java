...
public class ShowController {
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "201", description = "Show scheduled successfully"),
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Theater/Screen/Movie not found")
    })
    public ResponseEntity<ApiResponse<ShowResponse>> createShow(
            ...
            @Parameter(description = "Movie unique ID")
            @RequestParam String movieId,

            @Parameter(description = "Show start time in epoch milliseconds")
            @RequestParam Long startTime,

            @Parameter(description = "Time zone ID (Example: Asia/Kolkata)")
            @RequestParam String zoneId,
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Shows fetched successfully"),
    ...
    public ResponseEntity<ApiResponse<Page<TheaterShowProjection>>> fetchShows(
            ...
            @Parameter(description = "Show filtering request (date, pagination, etc.)")
            @ModelAttribute MovieShowsRequest request,

            @Parameter(description = "City name (Example: Bhubaneswar)")
            @RequestParam String city,
