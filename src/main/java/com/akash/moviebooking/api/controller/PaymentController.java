...
public class PaymentController {
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "Payment conflict / already processed")
    })
    public ResponseEntity<ApiResponse<PaymentResponseDto>> makePayment(

            @Parameter(description = "Payment request payload containing bookingId and payment details")
            @RequestBody PaymentRequestDto request,
    ...
    public ResponseEntity<ApiResponse<PaymentResponseDto>> getPayment(
            ...
            @Parameter(description = "Unique Payment ID")
            @PathVariable String id,
