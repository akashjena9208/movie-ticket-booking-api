////package com.akash.moviebooking.api.security.filters;
////
////import com.akash.moviebooking.api.security.dto.AuthenticatedTokenDetails;
////import com.akash.moviebooking.api.security.dto.ExtractedToken;
...
//            String role = claims.get("role", String.class);
//            String email = claims.getSubject();
//            log.debug("Token found, extracted claims, email: {}, role: {}", email, role);
//
//            if (isValid(role) && isValid(email) && SecurityContextHolder.getContext().getAuthentication() == null) {
...
//
//                SecurityContextHolder.getContext().setAuthentication(authToken);
//                log.info("User '{}' authenticated with role '{}'.", email, "ROLE_" + role);
//
//                AuthenticatedTokenDetails tokenDetails = new AuthenticatedTokenDetails(
//                        email,
//                        role,
